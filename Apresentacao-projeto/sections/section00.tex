...
\begin{frame}
	...
	\begin{itemize}
		\item <1-> Pokemon
		\item <2-> RL em jogos
		\item <3-> Capacidade em melhorias
	\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{Objetivo}
	\begin{block}{}
		É possível treinar um agente num ambiente de batalha pokemon mais próximo do real, visando simular o comportamento humano?
	\end{block}
\end{frame}
