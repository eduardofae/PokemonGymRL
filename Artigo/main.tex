...
Desde então, muita pesquisa foi realizada na área. Entre muitos marcos de trabalhos nesse campo de conhecimento, 
...
Seus tipos são importantes de serem levados em consideração também no contexto da batalha. Existem 18 tipos no mundo pokemon, cada um deles possuindo características em relação aos outros, como duplicar, cortar pela metade ou anular o dano causado pelo ataque de um oponente. Além disso, quando um pokemon ataca utilizando um movimento categorizado como seu próprio tipo, o poder deste golpe é multiplicado por um fator de 50\%, dinâmica importante para o combate.
